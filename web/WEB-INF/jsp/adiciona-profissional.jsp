                    ...
                    <div class="row bg-title">
                        ...
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Adicionar Profissional</li>
                            </ol>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="white-box">
                                ...
                                <ul class="nav customtab nav-tabs" role="tablist">
                                    <li role="presentation" class="nav-item"><a href="todos-profissionais" ><span class="visible-xs"><i class="ti-home"></i></span><span class="hidden-xs"> Todos os Profissionais</span></a></li>
                                    <li role="presentation" class="nav-item"><a href="adiciona-profissional" class="nav-link active"><span class="visible-xs"><i class="ti-user"></i></span> <span class="hidden-xs">Adicionar Profissional</span></a></li>
                                </ul>
                                <!-- Tab panes -->
                                                ...
                                                <form action="adicionando-profissional" class="form-horizontal" method="post">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3">Especialização</label>
                                                                    <div class="col-md-9">
                                                                        <select class="form-control" name="especializacao">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Insira o email" name="senha">
