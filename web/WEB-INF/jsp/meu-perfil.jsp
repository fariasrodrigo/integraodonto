                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="white-box">
                                ...
                                <p class="text-muted m-b-30">Visualize e altere suas informações aqui</p>
                                <!-- Nav tabs -->
                                <ul class="nav customtab nav-tabs" role="tablist">
                                    <li role="presentation" class="nav-item"><a href="meu-perfil" class="nav-link active"><span class="visible-xs"><i class="ti-home"></i></span><span class="hidden-xs"> Meu Perfil</span></a></li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade active in">
                                        <div class="col-md-12">
                                            <div class="white-box">
                                                <form action="alterando-perfil" class="form-horizontal" method="post" role="form">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" class="form-control" placeholder="" name="nome" value="${profissional.nome}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <select class="form-control" name="sexo" value="c">
                                                                            <option value="Masculino" ${profissional.sexo == 'Masculino'? 'selected' : ''}>Masculino</option>
                                                                            <option value="Feminino" ${profissional.sexo == 'Feminino'? 'selected' : ''}>Feminino</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" placeholder="" data-mask="999.999.999-99" class="form-control" name="cpf"  value="${profissional.cpf}"  ${readonly}>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!--/span-->
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" placeholder="" data-mask="99.999.999-99" class="form-control" name="rg"  value="${profissional.rg}" ${readonly}>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!--/span-->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" placeholder="Insira o celular, também utilizado para envio de SMS" data-mask="(99) 99999-9999" class="form-control" name="celular" value="${profissional.celular}"> </div>
                                                                </div>
                                                            </div>
                                                            <!--/span-->
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" placeholder="Insira o contato residencial ou comercial" data-mask="(99) 9999-9999" class="form-control" name="fixo" value="${profissional.fixo}"> </div>
                                                                </div>
                                                            </div>
                                                            <!--/span-->
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="email" placeholder=""  class="form-control" name="email" value="${profissional.email}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control" id="exampleInputuname" placeholder="Insira o login" name="login" value="${profissional.login}">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Insira o email" name="senha" value="${profissional.senha}">
