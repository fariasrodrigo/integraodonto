                    ...
                    <div class="row bg-title">
                        ...
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Receituário</li>
                            </ol>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="white-box">
                                ...
                                <p class="text-muted m-b-30">Visualize e adicione receitas ao paciente ... aqui</p>
                                <!-- Nav tabs -->
                                <ul class="nav customtab nav-tabs" role="tablist">
                                    <li role="presentation" class="nav-item"><a href="editar-paciente"><span class="visible-xs"><i class="ti-home"></i></span><span class="hidden-xs">Editar</span></a></li>
                                    ...
                                    <li role="presentation" class="nav-item"><a href="receituario-paciente" class="nav-link active" ><span class="visible-xs"><i class="ti-user"></i></span> <span class="hidden-xs">Receituário</span></a></li>
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade active in">
                                        <div class="col-lg-12">
                                            <div class="white-box">
                                                <ul class="pager">
                                                    <li class="previous"> <a href="#"><span class="text-muted"><i class="fa fa-calendar"></i></span>  Agendar Consulta</a> </li>
                                                </ul>
                                                    ...
                                                    <table class="table table-hover table-bordered">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>Dr. Rodrigo Farias</td>
                                                                <td>Elizama Farias Farias</td>
