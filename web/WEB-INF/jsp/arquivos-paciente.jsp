                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="white-box">
                                ...
                                <p class="text-muted m-b-30">Visualize e adicione os arquivos do paciente ... aqui</p>
                                <!-- Nav tabs -->
                                <ul class="nav customtab nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation" class="nav-item"><a href="arquivos-paciente" class="nav-link active" ><span class="visible-xs"><i class="ti-user"></i></span> <span class="hidden-xs">Arquivos</span></a></li>
                                </ul>
                                <!-- Tab panes -->
